          ...
          <CardContent>
            <div className="space-y-3 max-h-80 overflow-y-auto">
              {[
                ...
                <div
                  key={index}
                  className="text-xs border-l-2 border-primary pl-3 hover:bg-muted p-2 rounded transition-colors"
                >
                  <div className="text-muted-foreground font-mono">{log.time}</div>
                  <div className="text-foreground">
                    Agent <span className="text-primary font-mono">{log.agent}</span> {log.action}{" "}
                    <span className="text-foreground font-mono">{log.location}</span>
                    {log.target && (
                      <span>
                        {" "}
                        with agent <span className="text-primary font-mono">{log.target}</span>
                      </span>
                    )}
                  </div>
                </div>
        ...
        <Card className="lg:col-span-4 bg-card border-border">
          ...
          <CardContent className="flex flex-col items-center">
            ...
            <div className="text-xs text-muted-foreground space-y-1 w-full font-mono">
              ...
              <div className="text-primary">{"> CH#2 | 1231.9082464.500...xR3"}</div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4">
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-xs text-destructive font-medium">Failed Missions</span>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between text-xs">
                    <span className="text-muted-foreground">High Risk Mission</span>
